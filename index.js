...
function buttonAnimation(activeKey) {
    ...
    var alphabetKeys = ['w', 'a', 's', 'd', 'j', 'k', 'l'];

    var pressedKey = "";

    if (alphabetKeys.includes(activeKey)) {
        pressedKey = document.querySelector("." + activeKey);
    } else {
        pressedKey = document.querySelector(".a" + activeKey);
    }
